...
public class ChatRoomDetailsActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void clearGroupHistory() {
        EMConversation conversation = EMClient.getInstance().chatManager().getConversation(room.getId(), EMConversation.EMConversationType.ChatRoom);
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            setResult(RESULT_OK);
                            finish();
                            if (EaseChatActivity.activityInstance != null)
                                EaseChatActivity.activityInstance.finish();
                        }
                    });
