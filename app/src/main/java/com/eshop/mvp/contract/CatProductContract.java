 ...
 * ================================================
 */
public interface CatProductContract {
    //对于经常使用的关于UI的方法可以定义到IView中,如显示隐藏进度条,和显示文字消息
    interface View extends IView {
        void getCatProductsResult(GoodsBean data);
        void getCatBeanList(List<CatBean> data);
        void getCatProductsError(String msg);
    ...
    interface Model extends IModel {
        Observable<MyBaseResponse<GoodsBean>> getCatProducts(int pageNum,
