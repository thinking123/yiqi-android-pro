 ...
 * ================================================
 */
public class StoreInnerCatActivity extends BaseSupportActivity<StoreManagerPresenter> implements StoreManagerContract.View {
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_inner_cat; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.add_cat:
                ...
                new MaterialDialog.Builder(StoreInnerCatActivity.this)
                        .title("添加分类")
    ...
    private void request(String id){
        ...
        mPresenter.storeColumnList(mNextRequestPage,id);
    }
