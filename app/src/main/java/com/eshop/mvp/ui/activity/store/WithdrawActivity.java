...
public class WithdrawActivity extends BaseSupportActivity<StoreManagerPresenter> implements StoreManagerContract.View {
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_next:
                if(validate()){
                    mPresenter.drawing(BaseApp.loginBean.getToken(),drawBean);
                }
    ...
    public boolean validate() {
        ...
        String money_txt = money.getText().toString();
        String password_txt = password.getText().toString();

        String code_txt = code.getText().toString();

        if (money_txt.isEmpty() ) {
            showMessage("请输入提现金额");
       ...
       // if (BaseApp.withdraw_type.isEmpty() ) {
       //     showMessage("请选择提现账户");
       ...
       // }
        ...
        drawBean.setAccountId(BaseApp.withdraw_type);
        drawBean.setPhone(phones);
        drawBean.setPriceSum(money_txt);
        drawBean.setPwd(password_txt);
        drawBean.setStoreId(BaseApp.loginBean.getStoreId()+"");
        drawBean.setVcode(code_txt);
