package com.eshop.mvp.ui.widget.bottombar;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.bottom_navigation_unselected));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.bottom_navigation_unselected));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.bottom_navigation_selected));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.bottom_navigation_selected));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.bottom_navigation_unselected));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.bottom_navigation_unselected));
        }
    }
