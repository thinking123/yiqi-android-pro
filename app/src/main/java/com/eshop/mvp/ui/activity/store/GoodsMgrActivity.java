...
import com.eshop.mvp.ui.widget.CustomViewPager;
 ...
 * ================================================
 */
public class GoodsMgrActivity extends BaseSupportActivity<StoreManagerPresenter> implements StoreManagerContract.View {
    ...
    private void setupViewPager(CustomViewPager viewPager) {
        ...
        adapter.addFragment(StoreManagerFragment.newInstance(0), "销售中");
        adapter.addFragment(StoreManagerFragment.newInstance(1), "待审核");
        adapter.addFragment(StoreManagerFragment.newInstance(2), "待上架");
