...
public class OrderActivity extends BaseSupportActivity<OrderPresenter> implements OrderContract.View {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(OrderFragment.newInstance(10), "全部");
        adapter.addFragment(OrderFragment.newInstance(0), "待付款");
        adapter.addFragment(OrderFragment.newInstance(1), "待发货");
        adapter.addFragment(OrderFragment.newInstance(2), "待收货");
        adapter.addFragment(OrderFragment.newInstance(3), "已完成");
