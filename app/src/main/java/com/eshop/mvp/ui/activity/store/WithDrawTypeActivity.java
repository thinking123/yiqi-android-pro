 ...
 * ================================================
 */
public class WithDrawTypeActivity extends BaseSupportActivity<StoreManagerPresenter> implements StoreManagerContract.View {
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_withdraw_type; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }

    @Override
    public void initData(@Nullable Bundle savedInstanceState) {
        toolbarTitle.setText("提现方式");
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.cat_set: //银行账号
                BaseApp.withdraw_type = "2";
                finish();
                break;

            case R.id.publish: //微信账号
                BaseApp.withdraw_type = "1";
                finish();
                break;


            case R.id.zhifubao:
                BaseApp.withdraw_type = "0";
                finish();
                break;
