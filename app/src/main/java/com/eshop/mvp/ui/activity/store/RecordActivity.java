 ...
 * ================================================
 */
public class RecordActivity extends BaseSupportActivity<StoreManagerPresenter> implements StoreManagerContract.View {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(RecordFragment.newInstance(storeId,0), "未到账");
        adapter.addFragment(RecordFragment.newInstance(storeId,1), "已到账");
