 ...
 * ================================================
 */
public class PublishGoodsActivity extends BaseSupportActivity<StoreManagerPresenter> implements StoreManagerContract.View {
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_publish_goods; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.publish:
                if (veryfy() && mPresenter != null) {
                    mPresenter.goods(BaseApp.loginBean.getToken(), BaseApp.publishGoods);
                }
                break;

            case R.id.cat_set1:

                dialog = new MaterialDialog.Builder(PublishGoodsActivity.this)
    ...
    public void uploadImage() {
        ...
        new MaterialDialog.Builder(PublishGoodsActivity.this)
                .title("图片上传")
                .backgroundColorRes(R.color.white)
                .titleColorRes(R.color.color_3333)
