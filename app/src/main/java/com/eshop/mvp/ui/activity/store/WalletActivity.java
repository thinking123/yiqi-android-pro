 ...
 * ================================================
 */
public class WalletActivity extends BaseSupportActivity<StoreManagerPresenter> implements StoreManagerContract.View {
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_wallet; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        mPresenter.wallet(BaseApp.loginBean.getToken(),storeId);
    }

    @OnClick({R.id.cat_set,R.id.publish,R.id.btn_commit,R.id.look,R.id.textView21,R.id.income})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.income:
                ...
                intent6.putExtra("id",storeId);
                startActivity(intent6);
                break;

            case R.id.publish: //账号管理
                Intent intent3 = new Intent(this,SetAccountActivity.class);
            ...
            case R.id.btn_commit:
                Intent intent5 = new Intent(this,WithdrawActivity.class);
                startActivity(intent5);
                break;

            case R.id.look:

                Intent intent4 = new Intent(this,TransactionActivity.class);
                intent4.putExtra("id",storeId);
    ...
    public void walletSuccess(Wallet wallet) {
        ...
        Glide.with(this)
                .load(wallet.headPortrait)//new MultiTransformation(
                .apply(new RequestOptions().transforms(new CenterCrop(), new RoundedCorners(120)))
                .into(iv_header);

        money.setText(wallet.balance);
        income.setText(wallet.income);
    }
