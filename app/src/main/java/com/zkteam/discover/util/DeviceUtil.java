...
public class DeviceUtil {
    ...
    public static int getScreenWidth() {
        ...
        if (mScreenWidth == 0)
            mScreenWidth = BaseApp.getInstance().getResources().getDisplayMetrics().widthPixels;
    ...
    public static int getScreenHeight() {
        ...
        if (mScreenHeight == 0)
            mScreenHeight = BaseApp.getInstance().getResources().getDisplayMetrics().heightPixels;
