...
public class FrescoInitUtil {
    ...
    public static void initFrescoConfig() {
        ...
        ImagePipelineConfig pipeConfig = ImagePipelineConfig.newBuilder(BaseApp.getInstance())
                ...
                //设置磁盘缓存项配置
                .setMainDiskCacheConfig(getDisCacheConfigDefault(BaseApp.getInstance()))
                .setSmallImageDiskCacheConfig(getDisCacheConfigSmall(BaseApp.getInstance()))
        ...
        FrescoIniter.initialize(BaseApp.getInstance(), pipeConfig);
    ...
    public static class BitmapCacheParamsSupplier implements Supplier<MemoryCacheParams> {
        ...
        public MemoryCacheParams get() {
            ...
            mActivityManager = (ActivityManager) BaseApp.getInstance().getSystemService(Context.ACTIVITY_SERVICE);
